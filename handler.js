    ...
    try {
        ...
        try {
            ...
            if (chat) {
                ...
                if (!("sBye" in chat)) chat.sBye = "Goͮoͩdͩ ʙʸʸ"
                if (!("sDemote" in chat)) chat.sDemote = ""
                if (!("simi" in chat)) chat.simi = false
                if (!("sPromote" in chat)) chat.sPromote = ""
                if (!("sWelcome" in chat)) chat.sWelcome = "ⓦⓔⓛⓒⓞⓜⓔ 🅛🅤🅒🅘'🅢 ᴡᴏʀʟᴅ"
              ...
              for (let user of participants) {
                ...
                try {
                  ...
                  let welcomeApiUrl = `https://wecomeapi.onrender.com/welcome-image?username=${encodeURIComponent(
                    ...
                    'https://w0.peakpx.com/wallpaper/209/491/HD-wallpaper-cyberpunk-edgerunners-season-1.jpg'
                  )}`;
